      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            ...
            <Typography
              variant="caption"
              sx={{ color: COLORS.textSecondary, ml: 2, fontWeight: 500 }}
            >
              Chatty Desktop App
            </Typography>
          </Box>
          ...
          >
                ...
                >
                  <Typography
                    ...
                    sx={{
                      ...
                      color: chat.active ? "#FFF" : COLORS.textSecondary,
            ...
            <Box sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                <Box
                  sx={{ display: "flex", gap: 1, color: COLORS.textSecondary }}
                >
              ...
              >
                ...
                >
                  <Typography
                    variant="body2"
                    sx={{ color: COLORS.textSecondary, flex: 1 }}
                  >
                    Write a message in # General Team...
                  </Typography>
                  <SendIcon sx={{ color: COLORS.primaryLight, fontSize: 20 }} />
                </Box>
              </Box>
            </Box>
          </Box>
